...
console.log("ageOfThirdPerson", ageOfThirdPerson);
...
console.log("mothersNameOfSecondPerson", mothersNameOfSecondPerson);
...
console.log("animaltypeOfLisasPet", animaltypeOfLisasPet);
export {
  nameOfFirstPerson,
  homersOtherFriends,
  ageOfThirdPerson,
